     ...
     lambda_with_alias: function (scheduleAttributes, intermediaryLambdaFunctionName, alias) {
      ...
      if (!alias) {
       ...
       var sla = {
         ...
         name: intermediaryLambdaFunctionName || "callLambdaWithAlias",
       ...
       console.log("about to schedule "+scheduleAttributes.id+" to call lambda "+scheduleAttributes.name+" with alias "+alias+" via intermediary lambda "+intermediaryLambdaFunctionName);
